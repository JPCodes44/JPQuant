...
def bot():
    ...
    print(
        f"inpos {in_pos}, curr_size {curr_size}, bid {bid}, ask {ask}, sma20_15m {sma20_15m}, last close {last_close}"
    )
    ...
    if (bid > last_close) and (bid > sma20_15m):
        ...
        print(
            "just made a sell order because there was engulfing candle... sleep 2mins"
        )
        time.sleep(120)
    else:
